...
<div id="app">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-8 col-md-7 py-4">
            <h4 class="text-white">Vue BS-Components Example</h4>
            <p class="text-muted">
              This is a Vue.js example project using bs-components.  BS-Components is a web component library version of the
          ...
          <div class="col-sm-4 offset-md-1 py-4">
            ...
            <ul class="list-unstyled">
                <li><a href="https://bs-components.github.io/example-projects/vue/" class="text-white">Documentation</a></li>
              <li><a href="https://github.com/bs-components/bs-components" class="text-white">bs-components Github</a></li>
              <li><a href="https://github.com/jasoncubic" class="text-white">Author</a></li>
            </ul>
          </div>
        </div>
      </div>
  ...
  <div class="container my-5" id="app">
    ...
    <nav class="navbar">
      <ul id="scrollspy-example-navbar" class="nav nav-pills">
    ...
    <bs-scrollspy verbose-logging data-spy="scroll" data-target="#scrollspy-example-navbar" data-offset="0" style="position: relative; overflow: auto; height: 200px;">
      <div id="div-1">
        <h3>div 1</h3>
